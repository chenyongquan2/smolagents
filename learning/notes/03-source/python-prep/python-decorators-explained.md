...
读 [`@tool` 装饰器源码](../day2-tools/tool-decorator-implementation.md) 时遇到的疑问：
...
> 💡 **`@tool` 装饰器就是用 4.4 这种"返回实例"模式** —— 在装饰器内部定义 `class SimpleTool(Tool):`、实例化、返回实例（详见 [tool-decorator-implementation.md](../day2-tools/tool-decorator-implementation.md)）。
...
- 相关笔记：
  - [tool-decorator-implementation.md](../day2-tools/tool-decorator-implementation.md) — `@tool` 装饰器源码逐行解读（Day 2 段 5 彩蛋）
