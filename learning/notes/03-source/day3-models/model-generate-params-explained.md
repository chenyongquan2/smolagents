...
**这就是 Day 2 段 5 闭环的真正发生地** —— [tool-schema-rendering-mental-model.md](../day2-tools/tool-schema-rendering-mental-model.md) 预言"HTTP tools 字段不在 Tool 类上渲染"，Day 3 验证就在这。
...
详见 [python-args-kwargs.md](../python-prep/python-args-kwargs.md)、[model-generate-mental-model.md §4](model-generate-mental-model.md)。
...
- 子参数深入：
  ...
  - [tool-schema-rendering-mental-model.md](../day2-tools/tool-schema-rendering-mental-model.md) — `tools_to_call_from` 渲染机制（Day 2）
  - [chat-message-roles.md](../../02-concepts/chat-message-roles.md) — `messages` / `custom_role_conversions` 的 role 系统
  - [python-args-kwargs.md](../python-prep/python-args-kwargs.md) — `**kwargs` 语法
- 源码：
