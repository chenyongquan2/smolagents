...
2. **`@dataclass` 是代码生成器**：把"一堆字段+样板方法"的写法压缩成"几行注解"，这是 memory.py 能用 316 行容纳 8 个类的关键。详见 [python-class-and-dataclass.md](../python-prep/python-class-and-dataclass.md)
...
- Python 语法预习：[python-class-and-dataclass.md](../python-prep/python-class-and-dataclass.md)
