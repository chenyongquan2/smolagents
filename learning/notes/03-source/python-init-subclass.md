...
> 💡 这是 Python "MRO walk" 模式，Day 1 的 [callback-registry.md](callback-registry.md) 见过：CallbackRegistry 也用 `__mro__` 遍历父类。**任何"插钩子"型的设计，都要考虑链式传递的问题**。
...
- Day 1 类似主题笔记：
  ...
  - [callback-registry.md](callback-registry.md) — 同样用了 MRO walk 模式
