...
📚 **笔记溯源**：[python-sentinel-pattern.md](python-sentinel-pattern.md) §3 经典三场景
...
📚 **笔记溯源**：[tool-schema-rendering-mental-model.md](tool-schema-rendering-mental-model.md)（Day 2 写过的"4 种渲染形状"，Q4 这题就是其中两种的对比）
